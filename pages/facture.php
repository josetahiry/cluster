 ...
 <link href="../css/css2/bootstrap.min.css" rel="stylesheet">
  ...
  <body>
	...
	<section id="cart_items">
		<div class="container">
             <h1 align="center">Votre facture</h1>
			<div class="breadcrumbs"> 
				<ol class="breadcrumb">
				  <li><a href="acueil.php">ShopOnline</a></li>
				  <li class="active"><a href="panier.php">Facture</a></li>
				</ol>
			</div>
            <div class="row"> 
			<div class="col-lg-6">
            <h4><strong>CLIENT : <?php echo $nom;?></strong></h4>
            </div>
            <div class="col-lg-6">
            <h4><strong>DOIT à : ShopOnline</strong></h4>
            </div>
			</div>
						...
						<tr>
							...
							<td class="cart_quantity">
								<div class="cart_quantity_button">
									<a class="cart_quantity_up" style="font-size:20px" href="../inc/ajouterPanier.php?art=<?php echo $mylist; ?>"></a>
									<i><?php echo $count;?></i>
									<a class="cart_quantity_down" style="font-size:20px" href="../inc/enlevePanier.php?art=<?php echo $mylist; ?>"></a>
								</div>
							</td>
							<td class="cart_total">
